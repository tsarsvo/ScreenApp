...
- Рисовать можно и **за пределами выделения**: рамка сама расширится до нарисованного
...
| Рисовать за рамкой | просто ведите фигуру дальше — рамка расширится до нарисованного |
