...
<!-- Номер версии на кнопке и бейджах подставляется автоматически из последнего релиза -->
<a href="https://github.com/tsarsvo/ScreenApp/releases/latest/download/Kadr-Setup.exe">
  <img src="https://img.shields.io/github/v/release/tsarsvo/ScreenApp?display_name=tag&style=for-the-badge&label=%E2%AC%87%20%D0%A1%D0%BA%D0%B0%D1%87%D0%B0%D1%82%D1%8C%20%D0%B4%D0%BB%D1%8F%20Windows&color=3F6BFF&logo=windows&logoColor=white&cacheSeconds=300" alt="Скачать последнюю версию для Windows" height="42">
</a>

<sub><a href="https://github.com/tsarsvo/ScreenApp/releases/latest"><b>Что нового в последней версии</b></a> · <a href="https://github.com/tsarsvo/ScreenApp/releases">все версии и портативная сборка</a> · Windows 10/11 · бесплатно</sub>

<br><br>

<a href="https://github.com/tsarsvo/ScreenApp/releases/latest"><img src="https://img.shields.io/github/v/release/tsarsvo/ScreenApp?display_name=tag&label=%D0%BF%D0%BE%D1%81%D0%BB%D0%B5%D0%B4%D0%BD%D1%8F%D1%8F%20%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F&color=3F6BFF&cacheSeconds=300" alt="Последняя версия"></a>
...
- **Маркер**, **нумерованные шаги** ①②③ и **пикселизация**, чтобы скрыть пароли и личные данные
...
- **Закрепить снимок поверх окон** (<kbd>Ctrl</kbd>+<kbd>T</kbd>): перетаскивание, масштаб колесом, прозрачность
- **Автообновление**: новая версия ставится в один клик, с проверкой контрольной суммы
...
| <kbd>I</kbd> пипетка | ПКМ по кружку — свой цвет | <kbd>Ctrl</kbd>+<kbd>T</kbd> закрепить | |
