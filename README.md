...
<a href="https://github.com/tsarsvo/ScreenApp/releases/latest/download/Kadr-Setup.exe">
  <img src="https://img.shields.io/badge/%E2%AC%87%20%D0%A1%D0%BA%D0%B0%D1%87%D0%B0%D1%82%D1%8C%20%D0%B4%D0%BB%D1%8F%20Windows-v1.2.1-3F6BFF?style=for-the-badge&logo=windows&logoColor=white" alt="Скачать для Windows (kadr-version)" height="42">
</a>
...
<a href="https://github.com/tsarsvo/ScreenApp/releases/latest"><img src="https://img.shields.io/badge/%D0%BF%D0%BE%D1%81%D0%BB%D0%B5%D0%B4%D0%BD%D1%8F%D1%8F%20%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F-v1.2.1-3F6BFF" alt="Последняя версия (kadr-version)"></a>
...
- **Не снимается Диспетчер задач** (или другая программа, запущенная от администратора). Пока такое окно активно, Windows не передаёт обычным программам нажатия горячих клавиш. Запустите Kadr от имени администратора: правый клик по ярлыку → *Свойства → Совместимость →* «Запускать эту программу от имени администратора».
